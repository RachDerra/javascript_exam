...
$(document).ready(function () {
      ...
      function score_indicate() {
          ...
          let moyenne=Number(sum/subject_points.length);
      ...
      function get_achievement() {
          ...
          if (averageIndicate >= 80) {
            return "A";
          }if (averageIndicate >= 60 && averageIndicate<80) {
            return "B";
          }if (averageIndicate >= 40 && averageIndicate<60) {
            return "C";
          }if (averageIndicate >= 0 && averageIndicate<40) {
            return "D";
          }
      ...
      function get_pass_or_failure() {
          ...
          let judge = "Valider";
          $.each(subject_points,(index,element)=>{
            if (element<60) {
              judge="Echouer"
            }
